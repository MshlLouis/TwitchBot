# A Bot for Twitch that allows for the user to connect to Twitch Channels to read chat, Timeouts/Bans and Subscriptions/Bit-Cheers. Saves all those events to a database.
